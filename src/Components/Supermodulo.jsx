...
//       description: "O que é landing page, estrutura comum, princípios de design e introdução ao Figma.",
//       duration: "3h",
...
//       description: "Transforme wireframes em layouts, escolha cores e fontes, e exporte assets.",
//       duration: "3h",
...
//       description: "Ajustes finais, responsividade, GitHub, publicação no Vercel e apresentação.",
//       duration: "3h",
...
//             <Card
//               className={`relative bg-white/90 dark:bg-[#2D5A4A]/60 border-2 border-white/20 shadow-xl min-h-[200px]`}
//             >
...
//       {/* Course Content */}
//       <motion.section
//         className="relative z-20 max-w-7xl mx-auto px-6 py-12"
//         initial="hidden"
//         animate="show"
//         variants={container}
//       >
...
//           <p className="text-lg max-w-2xl mx-auto opacity-90 mt-3">
//             Um curso completo com 5 aulas de 3h — prático e direto ao ponto.
//           </p>
//         </div>
...
//               >
//                 <div
//                   className={`absolute -inset-2 rounded-2xl blur-lg opacity-0 hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r ${item.gradient}`}
//                 />

//                 <Card className="relative bg-white/85 dark:bg-[#2D5A4A]/50 border-2 border-white/10 shadow-md h-full">
//                   <CardContent className="p-6 text-center flex flex-col justify-between h-full">
//                     <motion.div
//                       className="w-16 h-16 bg-gradient-to-br from-[#E07A5F] to-[#E07A5F]/80 rounded-full flex items-center justify-center mx-auto mb-3"
...
//           <p className="text-lg max-w-2xl mx-auto opacity-90 mt-3">
//             Fundamentos e Base de Design para Landing Pages (3h, com intervalo de 15 min)
//           </p>
//         </div>

//         <div className="grid md:grid-cols-2 gap-8">
//           <motion.div variants={card} className="">
//             <Card className="bg-white/85 dark:bg-[#2D5A4A]/50 border-2 shadow-md min-h-[220px]">
...
//             ].map((s, i) => (
//               <Card key={i} className="p-4 bg-white/85 dark:bg-[#2D5A4A]/50 border-2 min-h-[150px]">
...
//       {/* Footer */}
//       <motion.footer
//         className="relative z-20 max-w-7xl mx-auto px-6 py-10 text-center"
//         initial="hidden"
//         animate="show"
//         variants={container}
//       >
  ...
  return (
    ...
    >
          ...
          {lessons.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <Card className="relative bg-white/85 dark:bg-[#F5F1EB]/10 border-2 border-white/10 shadow-md h-full">
                  <CardContent className="p-6 text-center flex flex-col justify-between h-full">
                    <motion.div
                      className="w-16 h-16 bg-gradient-to-br from-[#E07A5F] to-[#E07A5F]/80 rounded-full flex items-center justify-center mx-auto mb-3"
                      animate={{ y: [0, -6, 0], rotate: [0, 6, -6, 0] }}
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div variants={card} className="">
            <Card className="bg-white/85 dark:bg-[#F5F1EB]/10 border-2 shadow-md min-h-[220px]">
              <CardContent className="p-6 flex flex-col justify-between h-full">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#E07A5F] to-[#E07A5F]/80 rounded-full flex items-center justify-center">
                    <Lightbulb className="w-6 h-6 text-white" />
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div variants={card} className="grid grid-cols-2 gap-6">
            {[
              ...
              <Card key={i} className="p-4 bg-white/85 dark:bg-[#F5F1EB]/10 border-2 min-h-[150px]">
                <CardContent className="text-center flex flex-col justify-between h-full">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#E07A5F] to-[#E07A5F]/80 rounded-full flex items-center justify-center mx-auto mb-3">
                    <s.icon className="w-5 h-5 text-white" />
                  </div>
