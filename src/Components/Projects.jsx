...
//       {/* Easter Egg - Ícone de Bombom */}
//       <motion.div
//         className="fixed bottom-4 right-4 z-50 cursor-pointer bg-white dark:bg-jungle rounded-full p-3 shadow-lg"
...
//               animate={{ scale: 1, opacity: 1 }}
//               exit={{ scale: 0.8, opacity: 0 }}
//               className="bg-white p-8 rounded-lg shadow-xl max-w-md text-center relative overflow-hidden m-4"
//               onClick={(e) => e.stopPropagation()}
//             >
//               <h3 className="text-2xl font-bold text-jungle mb-4">Modo Chocólatra Ativado! 🍫</h3>
//               <p className="mb-4">
  ...
  return (
    <section id="projetos" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 min-h-screen">
        ...
        {/* Easter Egg - Ícone de Bombom */}
        <motion.div
          className="absolute bottom-4 right-4 cursor-pointer bg-white dark:bg-jungle rounded-full p-3 shadow-lg"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
          onMouseEnter={() => setIsHovered(true)}
          onMouseLeave={() => setIsHovered(false)}
