...
//   <motion.div
//     className="bg-white dark:bg-jungle p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center"
//     initial={{ opacity: 0, y: 20 }}
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ duration: 0.5, delay }}
//   >
//     <Icon className="w-12 h-12 text-terra mb-4" />
//     <h3 className="text-xl font-semibold text-jungle dark:text-sand mb-2">{title}</h3>
...
//   return (
//     <section id="conteudos" className="bg-sand dark:bg-jungle-dark py-16 px-4 sm:px-6 lg:px-8">
//       <div className="max-w-7xl mx-auto">
//         <motion.h2
//           className="text-4xl md:text-5xl font-bold text-center text-jungle dark:text-sand mb-8"
//           initial={{ opacity: 0, y: -20 }}
//           animate={{ opacity: 1, y: 0 }}
...
//         </motion.h2>
//         <motion.p
//           className="text-xl text-center text-gray-700 dark:text-gray-300 mb-12 max-w-3xl mx-auto"
//           initial={{ opacity: 0, y: -20 }}
//           animate={{ opacity: 1, y: 0 }}
...
//           <Link
//             to="/conteudos"
//             className="inline-flex items-center px-6 py-3 bg-terra text-white font-semibold rounded-full text-lg transition-transform duration-300 hover:scale-105"
//             onMouseEnter={() => setHoveredIndex(0)}
//             onMouseLeave={() => setHoveredIndex(null)}
//           >
//             Escolha um tema e comece agora!
//             <motion.div
